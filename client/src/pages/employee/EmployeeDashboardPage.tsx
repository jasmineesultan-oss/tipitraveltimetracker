...
import { cn, formatDate, phLocalToUtcIso, todayPhDateStr, utcIsoToPhLocalTime } from "@/lib/utils";
import { attendanceStatusVariant, holidayTypeLabel, workTypeLabel, workTypeVariant } from "@/lib/statusStyles";
...
export default function EmployeeDashboardPage() {
  ...
  const sessions = data?.todayAttendance?.sessions ?? [];
